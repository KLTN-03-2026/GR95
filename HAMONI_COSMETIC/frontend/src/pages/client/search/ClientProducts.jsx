        ...
        <div className="bg-white p-4 md:px-6 md:py-5 rounded-2xl border border-slate-200 shadow-sm mb-10 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 sticky top-[var(--client-nav-offset)] z-30">
          <div className="flex flex-wrap items-center gap-3 w-full">
            ...
            <div className="flex-1 min-w-[140px] max-w-[180px] ml-auto xl:ml-4 border-l xl:border-slate-200 xl:pl-4">
              <div className="flex items-center gap-2 relative">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-4 py-2.5 text-sm font-medium text-slate-700 outline-none focus:border-rose-300 focus:ring-2 focus:ring-rose-100 cursor-pointer appearance-none"
                >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-rose-50 hover:bg-rose-100 text-rose-600 rounded-xl text-sm font-bold transition-colors w-full xl:w-auto"
            >
              <RefreshCcw size={16} />{" "}
              <span className="xl:hidden">Làm mới bộ lọc</span>
            </button>
          </div>
        </div>
      ) : (
          ...
          <div className="flex items-center justify-end gap-2">
            <div className="flex items-center gap-2">
              ...
              <select
                value={sortOrder}
                onChange={(e) => setSortOrder(e.target.value)}
                className="bg-transparent border-0 text-sm font-semibold text-slate-700 pr-2 outline-none cursor-pointer"
              >
