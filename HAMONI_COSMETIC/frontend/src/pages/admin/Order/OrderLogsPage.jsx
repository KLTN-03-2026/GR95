        ...
        <div className="order-info-left">
          ...
          <div className="product-list">
            ...
            {orderData.chiTiet?.map((item, i) => (
              <div className="product-item" key={i}>
                {/* Cập nhật phần hiển thị hình ảnh */}
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/64?text=No+Image"; // Thay bằng link ảnh mặc định của dự án bạn
                  }}
                />
                ...
                <div className="product-details">
                  ...
                  <p className="product-sub">
                    {item.TenBienThe} | SL: {item.soLuong}
                  </p>
                </div>
          ...
          <div className="total-section">
            ...
            <span className="total-price">
              {Number(orderData.tongTien || 0).toLocaleString()}đ
            </span>
          </div>
        </div>
            ...
            {orderData.lichSu?.map((log, index) => (
              <tr key={index}>
                <td>
                  ...
                  {log.ghiChu && (
                    <small className="log-note">{log.ghiChu}</small>
                  )}
                </td>
